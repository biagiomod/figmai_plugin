...
export async function handler(event) {
    ...
    let status = 500;
    let errorCode;
    const withRequestIdHeader = (response) => {
    ...
    try {
        ...
        if (method !== 'OPTIONS' && !isHealth) {
            ...
            if (!expectedToken) {
                ...
                return withRequestIdHeader(json(500, { error: 'CONFIG_API_TOKEN is not configured' }, context.origin));
            }
        ...
        return withRequestIdHeader(json(500, {
