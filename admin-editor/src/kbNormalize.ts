 ...
 * Single source of truth for server normalize endpoint and scripts/convert-kb.ts (PR11b).
 */
...
/**
 * Parse markdown into a normalized KB document. Id must pass kbSchema validation when parsed.
 */
...
/**
 * Overlay loose object onto default doc and validate. Id must pass kbSchema validation.
 */
