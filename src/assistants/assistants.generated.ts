...
export const ASSISTANTS_MANIFEST: AssistantManifestEntry[] = [
  ...
  },
  {
    ...
    kind: "hybrid",
    quickActions: [
      { id: "send-json", label: "SEND JSON", templateMessage: "Paste a Design AI Toolkit Template JSON to generate Figma elements", executionType: "hybrid" },
